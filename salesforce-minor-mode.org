...
(defun sfmm:source:push
  ...
  (let* ((file-name (buffer-file-name))
         (push-command (sfmm--helper:build-sf-command "force" "source" "deploy" "-p" file-name "--json")))
...
(defun sfmm:source:retrieve
  ...
  (interactive)
  (let ((retrieve-command (sfmm--helper:build-sf-command "force" "source" "retrieve" "-p" buffer-file-name "--json")))
...
(define-minor-mode salesforce-minor-mode
  ...
  ;; (when-let ((org-default-alias (sfmm:org:show-current-org)))

  ;;   (if salesforce-minor-mode
  ;;       (condition-case index
  ;;           (-find-index (lambda (misc-info)
  ;;                         (eq `(" " ,org-default-alias " ") misc-info))
  ;;                        mode-line-misc-info)
  ;;         (error
  ;;          (add-to-list 'mode-line-misc-info `(" " ,org-default-alias " ")))
  ;;         (:success
  ;;          (setq mode-line-misc-info (-replace-at index `(" " ,org-default-alias " ") mode-line-misc-info))))
  ;;     (setq mode-line-misc-info (delete mode-line-misc-info `(" " ,sfmm:org-name " "))))))
