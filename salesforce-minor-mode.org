...
- [[#minor-mode][Minor Mode]]
  ...
  - [[#config-mode-key-map][config mode key map]]
...
(defcustom sfmm:salesforce-projects '()
  ""
  :type 'list
  :group 'saleforce-minor-mode)
...
(defvar salesforce-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "M-o c") #'sfmm:org:change)
...
(defun sfmm:set-projects ()
  "add config to projects."
  (cl-loop for dir in sfmm:salesforce-projects
