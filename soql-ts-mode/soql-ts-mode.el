...
;; Version    : 1.0.0
;; URL        : https://github.com/nverno/salesforce-minor-mode
...
;;
;; SOQL is the query language used by Salesforce to retrieve data from
;; the Salesforce database. It is similar to SQL but has specific syntax
;; and features for Salesforce objects and relationships.
;;
;; Features:
;; - Syntax highlighting using tree-sitter
;; - Intelligent indentation for queries and subqueries
;; - LSP integration (Eglot/LSP-Bridge)
;; - Completion support (CAPF/Company)
...
;;   (add-hook 'soql-ts-mode-hook #'eglot-ensure)  ; Optional LSP
;;
